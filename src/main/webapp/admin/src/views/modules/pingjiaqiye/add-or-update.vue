  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="企业名称" prop="qiyemingcheng">
              <el-input v-model="ruleForm.qiyemingcheng" 
                placeholder="企业名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="企业等级" prop="qiyedengji">
          <el-select v-model="ruleForm.qiyedengji" placeholder="请选择企业等级">
            <el-option
                v-for="(item,index) in qiyedengjiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="企业等级" prop="qiyedengji">
	      <el-input v-model="ruleForm.qiyedengji"
                placeholder="企业等级" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.pingjiashijian" label="评价时间" prop="pingjiashijian">
              <el-input v-model="ruleForm.pingjiashijian" 
                placeholder="评价时间" readonly></el-input>
                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="评价理由" prop="pingjialiyou">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.pingjialiyou" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.pingjialiyou" label="评价理由" prop="pingjialiyou">
                    <span v-html="ruleForm.pingjialiyou"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiyemingcheng = true;
            continue;
	            	            ...
	            	            if(o=='qiyedengji'){
            this.ruleForm.qiyedengji = obj[o];
	    this.ro.qiyedengji = true;
            continue;
          }
	            	            if(o=='pingjialiyou'){
            this.ruleForm.pingjialiyou = obj[o];
	    this.ro.pingjialiyou = true;
            continue;
          }
	            	            if(o=='pingjiashijian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                    ...
                                                                                                                                    this.qiyedengjiOptions = "1星,2星,3星,4星,5星".split(',')
                                                                },
                                                                        // 多级联动参数
                                                                                            info(id) {
      this.$http({
        url: `pingjiaqiye/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `pingjiaqiye/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.pingjiaqiyeCrossAddOrUpdateFlag = false;
                  this.parent.search();
