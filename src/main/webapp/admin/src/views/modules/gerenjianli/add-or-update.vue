          ...
          <el-form-item class="input" v-if="ruleForm.chushengriqi" label="出生日期" prop="chushengriqi">
              <el-input v-model="ruleForm.chushengriqi" 
                placeholder="出生日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="求职岗位" prop="qiuzhigangwei">
          <el-input v-model="ruleForm.qiuzhigangwei" 
              placeholder="求职岗位" clearable  :readonly="ro.qiuzhigangwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="求职岗位" prop="qiuzhigangwei">
              <el-input v-model="ruleForm.qiuzhigangwei" 
                placeholder="求职岗位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
