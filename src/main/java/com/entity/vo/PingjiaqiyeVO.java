 ...
 */
public class PingjiaqiyeVO  implements Serializable {
	...
	public void setPingjialiyou(String pingjialiyou) {
		this.pingjialiyou = pingjialiyou;
	}
	
	/**
	 * 获取：评价理由
	 */
	public String getPingjialiyou() {
		return pingjialiyou;
	}
